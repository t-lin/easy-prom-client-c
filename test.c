...
int main() {
    ...
    GaugeDeleteLabelValues(testGaugeVec, nLabels, labelVals);
    ...
    CounterDeleteLabelValues(testCounterVec, nLabels, labelVals);
    ...
    SummaryDeleteLabelValues(testSummaryVec, nLabels, labelVals);
